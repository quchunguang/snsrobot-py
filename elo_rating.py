...
def elo_rating(ranka, rankb, scorea, k=16):
    """
    :param ranka: player A's current rank score.
    :param rankb: player B's current rank score.
    :param scorea: 1 if A win, 0 otherwise.
    :param k: The K-factor. k = 16 by default.
    :return: return the new rank score for next rating.
    """
